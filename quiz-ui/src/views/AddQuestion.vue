<template>
    <div class="ml-2">
        ...
        <br>  
        <button type="button" class="text-sm px-4 py-2 border-2 rounded-lg text-white bg-blue-500 border-blue-500 hover:bg-blue-400" @click="send">Ajouter</button>
        </form>
        <br>
        <br>
        <button type="button">
...
export default{
    ...
    methods:{
        ...
        async send(){
            ...
            var reponse = await quizApiService.addQuestion(data, token);
